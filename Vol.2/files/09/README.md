...
[opamp_cs_full.sch](xschem/opamp_cs_full.sch)
![回路全体](img/opamp_cs_full_sch.png)
# 低電流源回路部分
電源部分はMaehashiさんに作って頂きました。ありがとうございます。
[VthRef.sch](xschem/VthRef.sch)
https://github.com/YuMaehashi/ISHI-KAI/tree/main/PTC06/202508_OPAMP
![低電流源回路部分](img/VthRef.png)
# テスト回路

[source_g.sch](xschem/source_g.sch)
[diffwl500-4.sch](xschem/diffwl500-4.sch)
[2stage_pc_3.sch](xschem/2stage_pc_3.sch)
...
ワクワクですね！
# レイアウト
[opamp_full.gds](klayout/opamp_full.gds)
