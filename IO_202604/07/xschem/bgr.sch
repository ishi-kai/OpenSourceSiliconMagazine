...
T {x60} 390 -90 0 0 0.25 0.25 {}
T {x60} 550 -90 0 0 0.25 0.25 {}
T {50ux2+(50u/5)x2} 230 -210 0 0 0.25 0.25 {}
T {50ux20} 290 -610 0 0 0.25 0.25 {}
T {50ux20} 90 -610 0 0 0.25 0.25 {}
T {50ux11} 460 -210 0 0 0.25 0.25 {}
...
N 520 -150 520 -110 {lab=#net11}
N 520 -50 520 -20 {lab=VSS}
N 380 -20 540 -20 {lab=VSS}
N 520 -600 520 -210 {lab=VBGR}
N 520 -340 600 -340 {lab=VBGR}
...
C {DP.sym} 360 -50 2 0 {name=D2 model=DP m=60}
...
C {MP.sym} 480 -820 0 0 {name=XMP3 model=PMOS w=20u l=4u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
...
tc1=0
tc2=0}
C {MP.sym} 480 -700 0 0 {name=XMP6 model=PMOS w=20u l=1u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {DP.sym} 520 -50 2 0 {name=D3 model=DP m=60}
C {devices/opin.sym} 600 -340 0 0 {name=p3 lab=VBGR}
C {RS.sym} 520 -210 0 0 {name=R4
w=4u
R=1
l=550u
model=F_RS
