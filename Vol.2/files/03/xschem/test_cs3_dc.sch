...
plot @m.x1.xmp1.m1[id] @d.x1.d1[id] @b.x1.xr4.br[i] xlabel Vdd ylabel Current
plot @m.x1.xmp2.m1[id] @d.x1.d2[id] @b.x1.xr5.br[i] xlabel Vdd ylabel Current
...
plot @m.x1.xmp1.m1[id] @d.x1.d1[id] @b.x1.xr4.br[i] ylabel Current
plot @m.x1.xmp2.m1[id] @d.x1.d2[id] @b.x1.xr5.br[i] ylabel Current
...
C {IP62LIB/RS.sym} 300 -150 0 0 {name=R1
w=4e-6
R=1
l=100e-6
model=F_RS
...
tc1=0
tc2=0}
C {IP62LIB/RS.sym} 580 -150 0 0 {name=R2
w=4e-6
R=1
l=100e-6
model=F_RS
