...
N 320 -340 340 -340 {lab=V2}
N 340 -340 340 -300 {lab=V2}
N 320 -300 340 -300 {lab=V2}
N 140 -340 160 -340 {lab=V1}
N 140 -340 140 -300 {lab=V1}
N 140 -300 160 -300 {lab=V1}
...
C {MP.sym} 200 -480 0 1 {name=XMP1 model=PMOS w=24u l=6u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {MN.sym} 200 -340 0 1 {name=XMN1 model=NMOS w=10u l=6u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {MP.sym} 280 -480 0 0 {name=XMP2 model=PMOS w=24u l=6u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {MN.sym} 280 -340 0 0 {name=XMN2 model=NMOS w=10u l=6u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
...
C {MP.sym} 440 -480 0 0 {name=XMP3 model=PMOS w=24u l=6u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
