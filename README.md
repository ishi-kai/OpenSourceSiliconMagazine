# ISHI会が頒布する同人誌や書籍、投稿した雑誌記事などのサポートサイトです。

## Open Source Silicon Magazineシリーズ
ISHI会で作成した同人誌をCCライセンスで頒布しています。  

### [Open Source Silicon Magazine Vol.1](/Vol.1/)
[インバータ回路のサンプル回路](https://github.com/ishi-kai/OpenRule1umPDK_setupEDA/tree/main/samples/inverter)に書かれていないもう一歩踏み込んなうんちくなどをまとめた書籍です。  
Re:Viewソースコード一式も公開しておりますので、自分で書籍化することも可能です。  

- ダウンロード先
    - [Open Source Silicon Magazine Vol.1のPDF版](/OpenSourceSiliconMagazine-Vol1.pdf)
    - [Open Source Silicon Magazine Vol.1のePub版](/OpenSourceSiliconMagazine-Vol1.epub)
    - [Open Source Silicon Magazine Vol.1のRe:Viewソースコード一式](/Vol.1/)
        - 自分でPDFなどをコンパイルしたい人向け

- ![OSSM_V1_TOP](/images/vol_1_cover.png)
- ![OSSM_V1_AGENDA](/images/vol_1_agenda1.png)


### [Open Source Silicon Magazine Vol.2](/Vol.2/)
...
- ![OSSM_V2_ICHIKEN](/images/vol_2_ICHIKEN.png)

- ![OSSM_V2_TOP](/images/vol_2_cover.png)
- ![OSSM_V2_AGENDA](/images/vol_2_agenda1.png)
...
#### [Open Source Silicon Magazine Vol.2](/Vol.2/)のサポートサイト
本書内で出てくる回路図やレイアウトファイルなどのソースコード一式をダウンロードしたり、その使い方を解説したサイトとなります。  

- [回路図やレイアウトファイルなどのサポートサイト](/Vol.2/file/)
...
- [インバータ回路のサンプル回路](https://github.com/ishi-kai/OpenRule1umPDK_setupEDA/tree/main/samples/inverter)
    - インバータ回路とは半導体設計におけるハローワールドやLチカに相当する回路です。
    - [インバータ回路の解説資料](https://github.com/3zki/lsi1_analog1/blob/main/analog_tutorial_jp.pdf)

#### 各種サンプル回路やレイアウト
- [サンプル回路配布サイト](https://github.com/ishi-kai/openmpw-transistor-level-examples)


## 雑誌記事
### [月刊I/O 2026年4月号](https://ishi-kai.org/article/io/2026/03/07/artcle_IO_202604.html)
特集「マイコン解体新書」マイコンの中身がどのように実装されているか？を解説して、自分で実装できるようになることを目的とした記事となります。  

#### サポートサイト
- [IO_202604ディレクトリ](/IO_202604/)をご覧ください。

- ![IO_202604_TOP](https://ishi-kai.org/assets/images/article/IO/IO_202604_TOP.jpg)
- ![IO_202604_SP_1stP](https://ishi-kai.org/assets/images/article/IO/IO_202604_SP_1stP.png)
