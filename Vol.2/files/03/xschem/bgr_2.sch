...
N 680 -150 680 -20 {lab=VSS}
N 540 -20 680 -20 {lab=VSS}
N 680 -260 720 -260 {lab=VBGR}
N 680 -670 680 -210 {lab=VBGR}
N 880 -880 880 -820 {lab=VDD}
N 860 -820 880 -820 {lab=VDD}
N 860 -790 860 -730 {lab=#net11}
N 860 -700 880 -700 {lab=VDD}
N 880 -820 880 -700 {lab=VDD}
N 700 -880 880 -880 {lab=VDD}
N 860 -880 860 -850 {lab=VDD}
N 780 -820 820 -820 {lab=#net1}
N 780 -820 780 -640 {lab=#net1}
N 520 -640 780 -640 {lab=#net1}
N 540 -520 800 -520 {lab=#net6}
N 800 -700 800 -520 {lab=#net6}
N 800 -700 820 -700 {lab=#net6}
N 860 -670 860 -480 {lab=IOUT}
...
C {MP.sym} 640 -820 0 0 {name=XMP3 model=PMOS w=20u l=4u m=40 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0q}
C {devices/opin.sym} 720 -260 0 0 {name=p3 lab=VBGR}
...
tc1=0
tc2=0}
C {MP.sym} 640 -700 0 0 {name=XMP6 model=PMOS w=20u l=1u m=40 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0q}
C {RS.sym} 680 -210 0 0 {name=R6
w=4u
R=1
l=100u*rr
model=F_RS
...
tc1=0
tc2=0}
C {MP.sym} 820 -820 0 0 {name=XMP7 model=PMOS w=20u l=4u m=42 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {MP.sym} 820 -700 0 0 {name=XMP8 model=PMOS w=20u l=1u m=42 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {devices/opin.sym} 860 -480 1 0 {name=p6 lab=IOUT}
